...
interface ErrorAlarmProps extends cloudwatch.MetricProps {
...
export class ErrorAlarm extends Construct {
  constructor(scope: Construct, id: string, props: ErrorAlarmProps) {
    super(scope, id);
